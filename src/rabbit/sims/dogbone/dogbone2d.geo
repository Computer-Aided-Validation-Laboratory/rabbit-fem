...
// Transfinite Curve{2,25,26} = gauge_leng_divs;
// Transfinite Curve{27,28,29,30} = gauge_width_divs;
// Transfinite Surface{s1} = {2,3,20,17};
// Recombine Surface{s1};
// Transfinite Surface{s2} = {2,3,22,21};
// Recombine Surface{s2};

// Extrude{0.0,0.0,spec_thick_thick}{
//     Surface{:}; Layers{spec_thick_layers}; Recombine;
// }

//------------------------------------------------------------------------------
// Physical lines and surfaces for export/BCs
Physical Surface("dogbone") = {Surface{:}};
Physical Curve("bc-base-disp") = {33,36};
Physical Curve("bc-top-disp") = {39,40};
